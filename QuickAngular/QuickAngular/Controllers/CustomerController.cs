...
namespace QuickAngular.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) response = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from QuickAngular", message);
