...
using QuickAngular.ViewModels;
using QuickAngular.Helpers;
using QuickAngular.Authorization;
...
namespace QuickAngular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("QuickAngular"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "QuickAngular API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "QuickAngular API V1");
            });
